 ...
 * input.
 */
public interface BufferedNativeSource extends NativeSource {
  ...
  NativeByteString readByteString(long byteCount) throws IOException;
   ...
   */
  void readFully(NativeBuffer sink, long byteCount) throws IOException;
   ...
   */
  long readAll(NativeSink sink) throws IOException;
  ...
  /** Equivalent to {@link #indexOf(NativeByteString, long) indexOf(bytes, 0)}. */
  long indexOf(NativeByteString bytes) throws IOException;
   ...
   * }</pre>
   */
  long indexOf(NativeByteString bytes, long fromIndex) throws IOException;

  /** Equivalent to {@link #indexOfElement(NativeByteString, long) indexOfElement(targetBytes, 0)}. */
  long indexOfElement(NativeByteString targetBytes) throws IOException;
   ...
   * }</pre>
   */
  long indexOfElement(NativeByteString targetBytes, long fromIndex) throws IOException;
   ...
   * }</pre>
   */
  boolean rangeEquals(long offset, NativeByteString bytes) throws IOException;
   ...
   */
  boolean rangeEquals(long offset, NativeByteString bytes, int bytesOffset, int byteCount)
      throws IOException;
